...
plt.show()
plt.plot(tso.cpm.position[80, 85, :])
...
#inod = np.arange(nintegrations).astype(int)
#prof_temp = np.ma.median(cleaned_image_test_roi[:, :, inod], axis=2)
#prof_temp2 = np.ma.median(image_test_roi[:, :, inod], axis=2)
#
#fig, ax = plt.subplots(figsize=(7, 5))
#ax.plot(np.arange(128),prof_temp[60,:], lw=3)
#ax.plot(np.arange(128),prof_temp2[60,:])
#ax.plot(cleaned_image_test_roi[60,:, 30])
#ax.set_xlim(64, 103)
#plt.show()
#
#fig, ax = plt.subplots(figsize=(7, 5))
#ax.plot(np.arange(128),prof_temp[60,:]-cleaned_image_test_roi[60,:, 30], lw=3)
#ax.set_xlim(64, 103)
#plt.show()
...
fig = plt.figure(figsize=(9, 6))
ax1 = plt.subplot(1, 1, 1)
ax1.plot(tso.observation.dataset.time.data.value[80, 85, :],
...
with quantity_support():
    fig, ax = plt.subplots(figsize=(7, 5))
    ax.plot(tso.observation.dataset.time.data[80, 85, :],
            tso.observation.dataset.data.data[80, 85, :], label='Data')
    ax.plot(tso.observation.dataset.time.data[80, 85, :],
            tso.calibration_results.model_time_series.data[80, 85, :],
            label='Model')
    ax.legend(loc='best')
...
for item in ([ax.title, ax.xaxis.label, ax.yaxis.label] +
             ax.get_xticklabels() + ax.get_yticklabels()):
    item.set_fontsize(20)
ax.plot(rebinned_wave, rebinned_spec-0.05, color="black", lw=5, alpha=0.9, zorder=5)
ax.errorbar(rebinned_wave, rebinned_spec-0.05, yerr=rebinned_error,
...
ax.plot(tso.exoplanet_spectrum.spectrum.wavelength,
        tso.exoplanet_spectrum.spectrum.data-0.05, lw=3, alpha=0.5, color='gray',
        zorder=2)
ax.errorbar(tso.exoplanet_spectrum.spectrum.wavelength.data.value,
            tso.exoplanet_spectrum.spectrum.data.data.value-0.05,
